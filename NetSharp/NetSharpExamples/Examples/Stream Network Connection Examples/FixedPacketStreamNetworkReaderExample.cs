...
{
    public class FixedPacketStreamNetworkReaderExample : INetSharpExample
    {
        ...
        /// <inheritdoc />
        public string Name { get; } = "Raw Fixed Packet-size Stream Network Reader Example";
        ...
        public Task RunAsync()
        {
            ...
            using RawStreamNetworkReader reader = new FixedPacketRawStreamNetworkReader(ref rawSocket, RequestHandler, defaultEndPoint, PacketSize, 100);
