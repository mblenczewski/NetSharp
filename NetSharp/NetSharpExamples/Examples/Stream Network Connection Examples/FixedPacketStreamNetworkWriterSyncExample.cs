...
{
    public class FixedPacketStreamNetworkWriterSyncExample : INetSharpExample
    {
        ...
        /// <inheritdoc />
        public string Name { get; } = "Raw Fixed Packet-size Stream Network Writer Example (Synchronous)";
