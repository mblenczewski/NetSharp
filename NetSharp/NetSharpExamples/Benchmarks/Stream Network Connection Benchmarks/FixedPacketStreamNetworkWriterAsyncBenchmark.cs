...
{
    public class FixedPacketStreamNetworkWriterAsyncBenchmark : INetSharpBenchmark
    {
        ...
        /// <inheritdoc />
        public string Name { get; } = "Raw Fixed Packet-size Stream Network Writer Benchmark (Asynchronous)";
